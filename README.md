...
<p align="left">
  <a href="https://skillicons.dev">
    <img src="https://skillicons.dev/icons?i=androidstudio,cs,css,dotnet,gop,git,git-lab,html,htmx,java,js,kali,linux,mysql,ps,php,powershell,pr,py,raspberrypi,visualstudio,vscode,windows,wordpress&perline=12 &theme=dark"/></a>
  </p>
